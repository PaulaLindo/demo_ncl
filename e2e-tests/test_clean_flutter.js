// e2e-tests/test_clean_flutter.js - Test clean Flutter project
const { chromium } = require('playwright');

const BASE_URL = 'http://localhost:8092';

async function testCleanFlutter() {
  console.log('🧼 TESTING CLEAN FLUTTER PROJECT');
  console.log('===============================');
  ...
  try {
    ...
    // Take screenshot
    await page.screenshot({ path: 'test-results/clean_flutter_test.png', fullPage: true });
    
    // Final diagnosis
    if (sceneHostExists && hasFlutterContent) {
      console.log('✅ SUCCESS: Clean Flutter project works!');
      console.log('   This means the issue is with your project configuration');
      ...
      console.log('❌ ISSUE: Same problem - Flutter loads but no scene host');
      console.log('   This indicates a system-wide Flutter web issue');
    } else {
...
testCleanFlutter().catch(console.error);
